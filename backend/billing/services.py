    ...
    def append_bill_row(self, bill) -> str:
        ...
        if self.bill_type == "OPD":
            rows = [[
                ...
                bill.patient.mobile_no,
                bill.patient.get_gender_display() if bill.patient.gender else "",
                str(bill.patient.age) if bill.patient.age is not None else "",
                str(bill.patient.pulse_rate) if bill.patient.pulse_rate is not None else "",
                str(bill.patient.weight) if bill.patient.weight is not None else "",
                str(bill.patient.height) if bill.patient.height is not None else "",
